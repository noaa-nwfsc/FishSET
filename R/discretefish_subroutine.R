...
#' @import shiny
#' @details Runs through model design choices generated by \code{\link{make_model_design}} and stored as `modelInputData` in FishSET database. 
...
#'     `(((polyn+1)*2)+2)*(k)` polynomial starting parameters, where (k) equals the number of alternative fishing choices. 
