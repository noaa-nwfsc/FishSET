...
trip_length <- function(dat, project, start, end, units = "days", catch = NULL, hauls = NULL, output = c("table", "plot"), haul_to_trip = FALSE, ...) {
    ...
    plots <- lapply(df, function(p) {
        ...
        ggplot2::ggplot(df, ggplot2::aes(x = p)) + ggplot2::geom_histogram() + fishset_theme
