...
#'
#' Create a map showing predicted probabilities by zone for a chosen policy scenario
#'
...
#' @details This function requires that model and prediction output tables exist in the FishSET database.
#' @import ggplot2
#' @import dplyr
#' @import sf
#' @export
...
predict_map <- function(project, policy.name, spat, zone.spat){
