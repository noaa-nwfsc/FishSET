    ...
    if (x == 0) {
        ...
        if (type == "point") {
            ...
            if (is.null(group) == FALSE & facet == FALSE) {
                ...
                mapout <- ggplot2::ggplot() + ggplot2::geom_map(data = world, map = world, ggplot2::aes(x = long, y = lat, map_id = region), fill = "grey", 
                  color = "black", size = 0.375) + ggplot2::geom_point(data = datatomap, ggplot2::aes(x = lon, y = lat, colour = groupv), size = 0.375, 
                  alpha = 0.25) + ggplot2::xlim(minlon, maxlon) + ggplot2::ylim(minlat, maxlat) + ggplot2::ggtitle("Points") + ggplot2::guides(colour = ggplot2::guide_legend(override.aes = list(size = 10))) + 
                  ggplot2::theme(text = ggplot2::element_text(size = 12), axis.title.y = ggplot2::element_text(vjust = 1.5), legend.title = ggplot2::element_blank(), 
                    panel.grid.major = ggplot2::element_blank(), panel.grid.minor = ggplot2::element_blank(), panel.background = ggplot2::element_blank(), 
                    panel.border = ggplot2::element_rect(colour = "black", fill = NA, size = 1)) + ggplot2::xlab("Longitude") + ggplot2::ylab("Latitude")
                
            } else if (is.null(group) == FALSE & facet == TRUE) {
                
                mapout <- ggplot2::ggplot() + ggplot2::geom_map(data = world, map = world, ggplot2::aes(x = long, y = lat, map_id = region), fill = "grey", 
                  color = "black", size = 0.375) + ggplot2::geom_point(data = datatomap, ggplot2::aes(x = lon, y = lat, colour = groupv), size = 0.375) + 
                  ggplot2::xlim(minlon, maxlon) + ggplot2::ylim(minlat, maxlat) + ggplot2::ggtitle("Points") + ggplot2::facet_wrap(. ~ groupv) + ggplot2::theme(text = ggplot2::element_text(size = 12), 
                  axis.title.y = ggplot2::element_text(vjust = 1.5), legend.position = "none", panel.grid.major = ggplot2::element_blank(), panel.grid.minor = ggplot2::element_blank(), 
                  panel.background = ggplot2::element_blank(), panel.border = ggplot2::element_rect(colour = "black", fill = NA, size = 1)) + ggplot2::xlab("Longitude") + 
                  ggplot2::ylab("Latitude")
                
            } else {
                
                mapout <- ggplot2::ggplot() + ggplot2::geom_map(data = world, map = world, ggplot2::aes(x = long, y = lat, map_id = region), fill = "grey", 
                  color = "black", size = 0.375) + ggplot2::geom_point(data = datatomap, ggplot2::aes(x = lon, y = lat), color = "black", size = 0.375) + 
                  ggplot2::xlim(minlon, maxlon) + ggplot2::ylim(minlat, maxlat) + ggplot2::ggtitle("Points") + ggplot2::theme(text = ggplot2::element_text(size = 12), 
                  axis.title.y = ggplot2::element_text(vjust = 1.5), panel.grid.major = ggplot2::element_blank(), panel.grid.minor = ggplot2::element_blank(), 
                  panel.background = ggplot2::element_blank(), panel.border = ggplot2::element_rect(colour = "black", fill = NA, size = 1)) + ggplot2::xlab("Longitude") + 
                  ggplot2::ylab("Latitude")
            }
            ...
            if (is.null(group) == FALSE & facet == FALSE) {
                ...
                mapout <- ggplot2::ggplot() + ggplot2::geom_map(data = world, map = world, ggplot2::aes(x = long, y = lat, map_id = region), fill = "grey", 
                  color = "black", size = 0.375) + ggplot2::geom_point(data = datatomap, ggplot2::aes(x = lon, y = lat, colour = groupv), color = "black", 
                  size = 0.375) + ggplot2::geom_density_2d(data = datatomap, ggplot2::aes(x = lon, y = lat, colour = groupv)) + ggplot2::xlim(minlon, 
                  maxlon) + ggplot2::ylim(minlat, maxlat) + ggplot2::ggtitle("Spatial kernel (contours)") + ggplot2::theme(text = ggplot2::element_text(size = 12), 
                  axis.title.y = ggplot2::element_text(vjust = 1.5), legend.title = ggplot2::element_blank(), panel.grid.major = ggplot2::element_blank(), 
                  panel.grid.minor = ggplot2::element_blank(), panel.background = ggplot2::element_blank(), panel.border = ggplot2::element_rect(colour = "black", 
                    fill = NA, size = 1)) + ggplot2::xlab("Longitude") + ggplot2::ylab("Latitude")
                ...
                mapout <- ggplot2::ggplot() + ggplot2::geom_map(data = world, map = world, ggplot2::aes(x = long, y = lat, map_id = region), fill = "grey", 
                  color = "black", size = 0.375) + ggplot2::geom_point(data = datatomap, ggplot2::aes(x = lon, y = lat, colour = groupv), color = "black", 
                  size = 0.375) + ggplot2::geom_density_2d(data = datatomap, ggplot2::aes(x = lon, y = lat, colour = groupv)) + ggplot2::xlim(minlon, 
                  maxlon) + ggplot2::ylim(minlat, maxlat) + ggplot2::ggtitle("Spatial kernel (contours)") + ggplot2::facet_wrap(. ~ groupv) + ggplot2::theme(text = ggplot2::element_text(size = 12), 
                  axis.title.y = ggplot2::element_text(vjust = 1.5), legend.position = "none", panel.grid.major = ggplot2::element_blank(), panel.grid.minor = ggplot2::element_blank(), 
                  panel.background = ggplot2::element_blank(), panel.border = ggplot2::element_rect(colour = "black", fill = NA, size = 1)) + ggplot2::xlab("Longitude") + 
                  ggplot2::ylab("Latitude")
                ...
                mapout <- ggplot2::ggplot() + ggplot2::geom_map(data = world, map = world, ggplot2::aes(x = long, y = lat, map_id = region), fill = "grey", 
                  color = "black", size = 0.375) + ggplot2::geom_point(data = datatomap, ggplot2::aes(x = lon, y = lat), color = "black", size = 0.375) + 
                  ggplot2::geom_density_2d(data = datatomap, ggplot2::aes(x = lon, y = lat)) + ggplot2::xlim(minlon, maxlon) + ggplot2::ylim(minlat, maxlat) + 
                  ggplot2::ggtitle("Spatial kernel (contours)") + ggplot2::theme(text = ggplot2::element_text(size = 12), axis.title.y = ggplot2::element_text(vjust = 1.5), 
                  legend.title = ggplot2::element_blank(), panel.grid.major = ggplot2::element_blank(), panel.grid.minor = ggplot2::element_blank(), panel.background = ggplot2::element_blank(), 
                  panel.border = ggplot2::element_rect(colour = "black", fill = NA, size = 1)) + ggplot2::xlab("Longitude") + ggplot2::ylab("Latitude")
            ...
            if (is.null(group) == FALSE & facet == FALSE) {
                ...
                mapout <- ggplot2::ggplot() + ggplot2::geom_map(data = world, map = world, ggplot2::aes(x = long, y = lat, map_id = region), fill = "grey", 
                  color = "black", size = 0.375) + ggplot2::geom_point(data = datatomap, ggplot2::aes(x = lon, y = lat, colour = groupv), color = "black", 
                  size = 0.375) + ggplot2::stat_density_2d(data = datatomap, ggplot2::aes(x = lon, y = lat, fill = stat(level)), geom = "polygon") + ggplot2::xlim(minlon, 
                  maxlon) + ggplot2::ylim(minlat, maxlat) + ggplot2::facet_wrap(. ~ groupv) + ggplot2::scale_fill_gradient(name = "Level\n(density)") + 
                  ggplot2::ggtitle("Spatial kernel (gradient)") + ggplot2::theme(text = ggplot2::element_text(size = 12), axis.title.y = ggplot2::element_text(vjust = 1.5), 
                  panel.grid.major = ggplot2::element_blank(), panel.grid.minor = ggplot2::element_blank(), panel.background = ggplot2::element_blank(), 
                  panel.border = ggplot2::element_rect(colour = "black", fill = NA, size = 1)) + ggplot2::xlab("Longitude") + ggplot2::ylab("Latitude")
                ...
                mapout <- ggplot2::ggplot() + ggplot2::geom_map(data = world, map = world, ggplot2::aes(x = long, y = lat, map_id = region), fill = "grey", 
                  color = "black", size = 0.375) + ggplot2::geom_point(data = datatomap, ggplot2::aes(x = lon, y = lat), color = "black", size = 0.375) + 
                  ggplot2::stat_density_2d(data = datatomap, ggplot2::aes(x = lon, y = lat, fill = stat(level)), geom = "polygon") + ggplot2::xlim(minlon, 
                  maxlon) + ggplot2::ylim(minlat, maxlat) + ggplot2::scale_fill_gradient(name = "Level\n(density)") + ggplot2::ggtitle("Spatial kernel (gradient)") + 
                  ggplot2::theme(text = ggplot2::element_text(size = 12), axis.title.y = ggplot2::element_text(vjust = 1.5), panel.grid.major = ggplot2::element_blank(), 
                    panel.grid.minor = ggplot2::element_blank(), panel.background = ggplot2::element_blank(), panel.border = ggplot2::element_rect(colour = "black", 
                      fill = NA, size = 1)) + ggplot2::xlab("Longitude") + ggplot2::ylab("Latitude")
            }
        }
