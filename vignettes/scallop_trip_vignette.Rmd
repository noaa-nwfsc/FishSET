...
data("scallop") # main data
data("scallop_ports") # port data
data("tenMNSQR") # spatial data
```
...
More FishSET functions can be found on the [references page](https://noaa-nwfsc.github.io/FishSET/reference/index.html). 
