...
```
The northeast scallop dataset uses an obscured version of trip-level data from the scallop fishery. These data are provided for illustrative purposes.
...
|previous_port_lon |num | longitude of the previouslanding port, decimal degrees|
