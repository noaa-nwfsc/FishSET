...
This document includes basic instructions on how to use the FishSET GUI. Refer to the [FishSET User Manual](https://docs.google.com/document/d/1t8ZWrtmV0gV5etClT-ITTJMTH89GnvaqTNYtQJsLLaE/edit) for information on installing R software and to the [main page](https://noaa-nwfsc.github.io/FishSET/index.html) of this website for FishSET installation instructions.
...
See [Chapter 4 of the FishSET User Manual](https://docs.google.com/document/d/1t8ZWrtmV0gV5etClT-ITTJMTH89GnvaqTNYtQJsLLaE/edit#heading=h.3as4poj) for more information on the different types of data.
...
See the recommended data quality checks in [Chapter 4 of the FishSET User Manual](https://docs.google.com/document/d/1t8ZWrtmV0gV5etClT-ITTJMTH89GnvaqTNYtQJsLLaE/edit#heading=h.gvjfmr8m6yax).
...
For more details see [Chapter 6 of the FishSET User Manual](https://docs.google.com/document/d/1t8ZWrtmV0gV5etClT-ITTJMTH89GnvaqTNYtQJsLLaE/edit#heading=h.g2cn6i5a6srj).
...
See [Chapter 8 of the FishSET User Manual](https://docs.google.com/document/d/1t8ZWrtmV0gV5etClT-ITTJMTH89GnvaqTNYtQJsLLaE/edit#heading=h.3cqmetx) for more information on defining alternative choices and model development.
...
See [Chapter 8 of the FishSET User Manual](https://docs.google.com/document/d/1t8ZWrtmV0gV5etClT-ITTJMTH89GnvaqTNYtQJsLLaE/edit#heading=h.3cqmetx) for more information about how expected catch/revenue is calculated and model development.
...
See [Chapter 8 of the FishSET User Manual](https://docs.google.com/document/d/1t8ZWrtmV0gV5etClT-ITTJMTH89GnvaqTNYtQJsLLaE/edit#heading=h.3cqmetx) for more information on model development.
...
For more information on simulating policy scenarios see [Chapter 9 of the FishSET User Manual](https://docs.google.com/document/d/1t8ZWrtmV0gV5etClT-ITTJMTH89GnvaqTNYtQJsLLaE/edit#heading=h.3q5sasy).
