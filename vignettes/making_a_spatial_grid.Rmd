...
If using the FishSET GUI: navigate to the **Select variables** tab, use the *Create zone ID column* button, and follow the directions to reassign zone IDs in the primary data table.
