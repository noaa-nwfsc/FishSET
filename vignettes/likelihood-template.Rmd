...
Give your likelihood function an informative name (replace `likelihood_function` in the code chunk above) and save the script with the same name. Only include the likelihood function in the R script. 
