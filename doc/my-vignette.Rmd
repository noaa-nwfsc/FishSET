 ...
 * read.dat  Import data into R from several formats
 ...
 * tablesDatabase()   View tables in the fishset_db database
 * tableFields(x)     View fields in the table (here table x)
 * tableFields(x)     View table x from the fishset_db database
...
###Run model functions  
  ...
  Multiple likelihood function have been written. Users can alsowrite their own likelihood functions.
    * logit_c
    * logit_avgcat
    * epm_normal
    * epm_lognormal
