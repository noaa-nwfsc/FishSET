...
##Data Exploration\
View the spatial (`map_plot`) distribution of data. Plots and
...
case, vessels are grouped based on define_group parameter. Medium-term:
...
with Dahl's correction function
...
variables to keep in the working data set.
