...
test_that("change_class returns data frame and prints class table without changes", {
  ...
  expect_warning(
    result <- change_class(result_main, "s1", log_fun = FALSE),
...
test_that("change_class correctly changes a character to numeric", {
  ...
  expect_message(
    result <- change_class(result_main, "s1", x = "DDLAT", new_class = "numeric", log_fun = FALSE),
...
test_that("change_class correctly changes a numeric to a factor", {
  ...
  expect_message(
    result <- change_class(result_main, "s1", x = "TRIPID", new_class = "factor", log_fun = FALSE),
    "Variable class changed."
  )
...
test_that("change_class correctly changes a character string to a date", {
  ...
  expect_message(
    result <- change_class(result_main, "s1", x = "test_date", new_class = "date", log_fun = FALSE),
    "Variable class changed."
  )
  ...
  expect_message(
    result <- change_class(
     result_main, "s1", 
      ...
      new_class = c("character", "factor") ,log_fun = FALSE
    ),
    "Variable class changed."
  )
