...
test_that("Converts integer to numeric", {
  ...
  out <- change_class(temp_dat, "pollock", x = "A", newclass = "numeric")
...
test_that("Correctly converts numeric to character", {
  ...
  out <- change_class(temp_dat, "pollock", x = "A", newclass = "character")
...
test_that("Converts integer to factor", {
  ...
  temp_dat <- data.frame(A = as.integer(1:10), B = runif(10))
  out <- change_class(temp_dat, "pollock", x = "A", newclass = "factor")
...
test_that("Converts date factor to date", {
  ...
  out <- change_class(temp_dat, "pollock", x = "A", newclass = "date")
