...
#   - Correct application of 'temp.lag' and 'year.lag'.
#   - Handling of missing data via 'empty.catch' and 'empty.expectation'.
#   - Creation of a binary dummy matrix when 'dummy.exp' is TRUE.
