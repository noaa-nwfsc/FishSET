source("fleetServ.R", local = TRUE, encoding = "UTF-8")
source("fleetUI.R", local = TRUE, encoding = "UTF-8")
source("fleet_helpers.R", local = TRUE, encoding = "UTF-8")
source("map_viewer_app.R", local = TRUE, encoding = "UTF-8")
source("zone_outsample_UI.R", local = TRUE, encoding = "UTF-8")
source("zone_outsample_server.R", local = TRUE, encoding = "UTF-8")
source("zone_closure_UI.R", local = TRUE, encoding = "UTF-8")
source("zone_closure_Server.R", local = TRUE, encoding = "UTF-8")
source("run_policy_UI.R", local = TRUE, encoding = "UTF-8")
source("run_policy_server.R", local = TRUE, encoding = "UTF-8")
source("select_variables_UI.R", local = TRUE, encoding = "UTF-8")
source("select_variables_server.R", local = TRUE, encoding = "UTF-8")
source("checklist_module.R", local = TRUE, encoding = "UTF-8")
...
### SERVER SIDE    
heavy_server <- function(input, output, session) {
 ...
 output$resultUp <- renderUI({
  ...
  portdat <- reactiveValues(
    dataset = data.frame('var1'=0, 'var2'=0)
  )
  
  portdat_temp <- reactiveValues(
    dataset = data.frame('var1' = 0, 'var2' = 0)
  )
